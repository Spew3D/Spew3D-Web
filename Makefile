...
unittests:
	...
	for x in $(UNITTEST_BASENAMES_WITHSDL); do $(CC) -g -O1 $(CFLAGS) -Iinclude/ -I./vendor/Spew3D/include/ $(CXXFLAGS) -pthread -o ./$$x$(BINEXT) ./$$x.c -lSDL2 -lcheck -lrt -lm $(LDFLAGS) || { exit 1; }; done
	for x in $(UNITTEST_BASENAMES_NOSDL); do $(CC) -g -O1 $(CFLAGS) -Iinclude/ -I./vendor/Spew3D/include/ $(CXXFLAGS) -pthread -o ./$$x$(BINEXT) ./$$x.c -lcheck -lrt -lm $(LDFLAGS) || { exit 1; }; done
